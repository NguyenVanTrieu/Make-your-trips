...
function pushMarker(m) {
    ...
    switch (document.getElementById('state').value) {
        case '1':
            iconstate = "class='fa fa-hourglass-start' title='Điểm bắt đầu'";
            break;
        case '2':
            iconstate = "class='fa fa-hourglass-end' title='Điểm kết thúc'";
            break;
        case '3':
            iconstate = "class='fa fa-bed' title='Điểm Nghỉ ngơi'";
            break;
        case '4':
            iconstate = "class='fa fa-reddit-alien' title='Điểm vui chơi'";
            break;
        case '5':
            iconstate = "class='fa fa-cutlery' title='Ăn'";
            break;
        case '6':
            iconstate = "class='fa fa-coffee' title='Uống'";
            break;
        case '7':
            iconstate = "class='fa fa-eye' title='Ngắm cảnh'";
            break;
        case '8':
            iconstate = "class='fa fa-users' title='Hội họp'";
            break;
        case '9':
            iconstate = "class='fa fa-user-o' title='Tự do'";
            break;
    }
    var n = lats.length - 1;
...
function saveToDB() {
    ...
    if (name != "") {
        ...
        /* $.ajax({
         ...
         url: "http://localhost:8000/luu-tuyen-duong",
         data: data,
